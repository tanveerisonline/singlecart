                    ...
                    <tr key={customer.id} className="hover:bg-gray-50/50 transition-all duration-200 group">
                      ...
                      <td className="px-6 py-5 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button className="inline-flex items-center justify-center h-8 px-4 rounded-lg bg-gray-50 text-gray-600 text-xs font-bold hover:opacity-90/10 hover:text-primary transition-all">
                            View Activity
                          </button>
